...
returnReviews(APILINK); //the link we want to fetch from is the API, getting default movies from the API 
  ...
  .then(function(data){
    ...
    data.forEach(review => {
      ...
      div_card.innerHTML = `
        <div class = "row">
            <div class = "column">
                <div class = "comment" id = "${review._id}">
      ...
      //appending all the divs to main, which is the section✏️
